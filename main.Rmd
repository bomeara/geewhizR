...
Let's get some images of the most commonly identified salamander in the area, `r salamander_summary$species[which.max(salamander_summary$n_observations)]`. We'll use the `rinat` package to get data from the iNaturalist API.
...
knox_area_map <- get_stadiamap(location)
